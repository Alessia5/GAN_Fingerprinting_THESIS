...
def generate_GAN_Classifier_VisNet_Fingerprinting_PreDownsampling(input_shape):
    model = Sequential()
    # network b
    model.add(Conv2D(3, kernel_size=(3, 3), activation='relu', input_shape=(128, 128, 3), padding='same'))  # (8x8x3)
...
def generate_GAN_Classifier_VisNet_Fingerprinting_PreDownsampling_NoPooling(input_shape):
    model = Sequential()
    # network b
    model.add(Conv2D(3, kernel_size=(3, 3), activation='relu', input_shape=(128, 128, 3), padding='same'))  # (8x8x3)
...
model = generate_GAN_Classifier_VisNet_Fingerprinting_PreDownsampling(input_shape)
model.summary()    